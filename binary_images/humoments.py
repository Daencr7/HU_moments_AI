...
# Thư mục chứa ảnh
folder_path = "./"  # nếu ảnh nằm cùng folder với script
output_csv = "hu_features.csv"

# Lưu kết quả
with open(output_csv, mode='w', newline='') as f:
    writer = csv.writer(f)
    # Ghi header
    header = ["Image", "Hu1", "Hu2", "Hu3", "Hu4", "Hu5", "Hu6", "Hu7"]
    ...
    for i in range(1, 51):
        ...
        try:
            ...
            # Ghi vào CSV
            writer.writerow([image_name] + hu_features.tolist())
